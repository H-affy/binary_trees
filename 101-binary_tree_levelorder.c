 ...
 *
 * Return: Null if error occurs, else a new pointer to the new node
 */
levelorder_queue_t *create_node(binary_tree_t *node)
{
...
/**
 * free_queue - a function that free levelorder_queue_t queue
...
/**
 * pint_push - a function that run function on a given binary tree node and
 * pushes it chhildren into levelorder queue
